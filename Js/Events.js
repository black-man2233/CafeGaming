...
function insertEvents() {
  ...
  for (var i = 0; i < events.length; i++) {
    ...
    signUpButton.classList.add("signUpEventButton");
    ...
    // Swap the position of the buttons
    eventCard.appendChild(eventImage);
    eventCard.appendChild(eventTitle);
    eventCard.appendChild(eventDescription);
    eventCard.appendChild(eventDate);
    eventCard.appendChild(readMoreButton);
    eventCard.appendChild(space); // Add the space between the buttons
    eventCard.appendChild(signUpButton);
